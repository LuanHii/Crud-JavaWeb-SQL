...
CREATE TABLE `softwares` (
  ...
  CONSTRAINT `id_computador` FOREIGN KEY (`id_software`) REFERENCES `pc` (`id_pc`)
...
INSERT INTO `softwares` VALUES (1,'Paint',1,1),(2,'Adobe Premiere',1,1),(3,'Paint',2,2),(4,'Photoshop',3,3);
